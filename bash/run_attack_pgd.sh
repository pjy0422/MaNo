...
#SBATCH --exclude=n68
#
# MaNo PGD Attack (10 steps): 3 architectures x 3 datasets, parallelized across 3 GPUs.
#
# Usage:
#   bash bash/run_attack_pgd.sh
...
WANDB_GROUP="${WANDB_GROUP:-attack_comparison-pgd10}"
WANDB_TAGS="${WANDB_TAGS:-attack,pgd}"
...
echo "Mode: ${ATTACK_MODE}, steps=${ATTACK_STEPS}"
