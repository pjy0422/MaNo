...
#SBATCH --exclude=n68
#
# MaNo Analytical Attack (zero-cost): 3 architectures x 3 datasets, parallelized across 3 GPUs.
#
# Usage:
#   bash bash/run_attack_anal.sh

DATA_ROOT=./datasets
RESULTS_DIR="${RESULTS_DIR:-results_attack}"

ATTACK_MODE="analytical"
...
WANDB_GROUP="${WANDB_GROUP:-attack_comparison-analytical}"
WANDB_TAGS="${WANDB_TAGS:-attack,analytical}"
